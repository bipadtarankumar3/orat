...
export default function Productpage() {
    ...
    const { items: products, offset, limit, hasMore, status, filters } = useSelector((state) => state.products);

    // Load products on component mount and when filters change
    useEffect(() => {
        console.log('limit, filters');
        dispatch(resetProducts());
        dispatch(fetchProducts({ offset: 0, limit, filters }));
                            ...
                            <div className="category-div">
                                <Link to="/singleproduct" target='_blank' className='ProductCard'>     
                                    ...
                                    <div className="ProductCardBottom">
                                        <h6 class="ProductCardTitle ellipsis demi-bold">{product.product_title}</h6>
                                        <p class="ProductCardDescription p2 ellipsis-two-line">{product.product_short_description}</p>
                                        <div>
